...
public class AppModule {
    @Qualifier @Retention(RetentionPolicy.RUNTIME) public @interface IoExecutor {}
    @Qualifier @Retention(RetentionPolicy.RUNTIME) public @interface DefaultExecutor {}
    @Qualifier @Retention(RetentionPolicy.RUNTIME) public @interface MainExecutor {}
